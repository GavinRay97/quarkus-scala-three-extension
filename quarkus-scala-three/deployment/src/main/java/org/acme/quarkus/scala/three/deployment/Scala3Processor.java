...
public class Scala3Processor {
  ...
  private static final String FEATURE = "scala3-extension";
  ...
  // @BuildStep
  // void
  // registerScalaJacksonModule(BuildProducer<ClassPathJacksonModuleBuildItem>
  // classPathJacksonModules) {
  // try {
  // Class.forName(SCALA_JACKSON_MODULE, false,
  // Thread.currentThread().getContextClassLoader());
  // classPathJacksonModules.produce(new
  // ClassPathJacksonModuleBuildItem(SCALA_JACKSON_MODULE));
